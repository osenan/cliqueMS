...
Annotation steps are stored in an `anClique` S3 object.
...
S3 object, which will be used to store all annotation steps.
...
user or either use one of the default adduct lists. Here is how it looks the
positive default list:
...
Which contains the name of the adduct, the log10 frequency of that adduct,
the mass of the adduct, the number of molecules involved and the charge
(see [1] for details in how default lists were made). With the adduct
list we can obtain neutral masses.
