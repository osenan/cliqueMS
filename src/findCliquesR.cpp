...
// [[Rcpp::export]]
Rcpp::DataFrame returnCliques(Rcpp::DataFrame netdf, double tol = 0.000001, bool verbose = false) {
  ...
  int stepsize = 10;
  std::vector<double> loglList = aggregateANDkernighan(net, tol, step = stepsize, silent = verbose);
